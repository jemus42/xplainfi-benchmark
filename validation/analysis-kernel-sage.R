...
res <- combine_reduced(
	latest_reduced("validation", "xplainfi"),
	latest_reduced("validation", "reference")
)
...
saveRDS(out, here::here("results", "validation", "kernel-sage-validation.rds"))
cli::cli_alert_success("Wrote results/validation/kernel-sage-validation.rds")
